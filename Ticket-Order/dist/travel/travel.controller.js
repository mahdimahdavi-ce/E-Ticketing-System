...
const travel_controller_base_1 = require("./base/travel.controller.base");
const public_decorator_1 = require("../decorators/public.decorator");
let TravelController = class TravelController extends travel_controller_base_1.TravelControllerBase {
    constructor(service, rolesBuilder) {
        super(service, rolesBuilder);
        this.service = service;
        this.rolesBuilder = rolesBuilder;
    }
    async getAllTravels(queries) {
        console.log(queries);
...
], TravelController.prototype, "getAllTravels", null);
